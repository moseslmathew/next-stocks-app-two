...
export const metadata = {
  title: 'TradeMind - AI-Powered Stock Analysis',
      ...
      <section className="relative py-12 lg:py-32 overflow-hidden">
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-3xl mx-auto">
                <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white/80 dark:bg-gray-800/80 border border-blue-200 dark:border-blue-900/50 text-blue-600 dark:text-blue-400 mb-6 shadow-sm backdrop-blur-sm animate-fade-in">
                ...
                <div className="flex justify-center gap-4 mb-8">
                    <SignedOut>
                        <SignInButton mode="modal">
                            <button className="inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-full bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm transition-all shadow-lg shadow-blue-600/25 hover:scale-105">
                    ...
                    <SignedIn>
                        <Link href="/watchlist/indian" className="inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-full bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm transition-all shadow-lg shadow-blue-600/25 hover:scale-105">
                            Go to Dashboard
                            <ArrowRight size={16} />
                        </Link>
                    </SignedIn>
