        ...
        <div className="flex flex-col gap-4 p-6 border-b border-gray-100 dark:border-gray-800">
            ...
            <form onSubmit={handleSearchSubmit} className="relative">
                <input
                    ...
                    className="w-full pl-10 pr-4 py-2 rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all font-medium text-sm"
                />
