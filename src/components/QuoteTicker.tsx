...
export default function QuoteTicker() {
  ...
  return (
    <div className="flex flex-col md:flex-row items-start gap-4 md:gap-8 w-full pb-6 md:pb-8 animate-fade-in pt-4 md:pt-8 mt-2 md:mt-4">
        ...
        <div className="max-w-lg w-full text-left shrink-0">
            ...
            <div className={`relative transition-opacity duration-300 ${loading ? 'opacity-50' : 'opacity-100'} min-h-[100px]`}>
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex items-center justify-start gap-2 opacity-60 mb-2">
                    ...
                    {quote.explanation && !showExplanation && (
                        <button 
                            ...
                            className="text-[10px] font-medium text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300 transition-colors border-b border-dashed border-violet-300 dark:border-violet-700 pb-0.5 mt-1"
                        >
                            Know More
                        </button>
                    )}
        ...
        {quote.explanation && showExplanation && (
            <div className="flex-1 max-w-xl w-full animate-in slide-in-from-left-2 fade-in duration-500">
                 <div className="relative overflow-hidden text-sm text-gray-800 dark:text-gray-200 bg-white/60 dark:bg-zinc-900/60 backdrop-blur-xl p-5 rounded-xl border border-white/60 dark:border-white/10 shadow-xl shadow-black/5 dark:shadow-black/20 text-left w-full group ring-1 ring-white/50 dark:ring-white/5">
                    ...
                    <div className="flex justify-between items-start mb-2 relative z-10">
                        <h4 className="text-xs font-bold text-violet-600 dark:text-violet-400 uppercase tracking-wider">Insight</h4>
                        <button onClick={() => setShowExplanation(false)} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors">
